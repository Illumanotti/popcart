...
//	}
		...
		$scope.addToCart=function(username){
			...
			jQuery.post( "https://popcart.herokuapp.com/scripts/addToCart.php", { buyer: $scope.buyer, seller: seller,productID:productID }).done(function( data ) {
				console.log(data);
			  });
		};
